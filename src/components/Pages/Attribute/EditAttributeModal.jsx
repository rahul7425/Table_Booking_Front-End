...
const EditAttributeModal = ({ attribute, onClose, onUpdate }) => {
        ...
        <div className="flex flex-col w-full h-full justify-between bg-white dark:bg-gray-800">
          ...
          <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <div className="flex md:flex-row flex-col justify-between items-center">
              <div>
                <h4 className="text-xl font-medium dark:text-gray-300">Update Attribute</h4>
            ...
            <form onSubmit={handleSubmit}>
              <div className="px-6 pt-8 flex-grow w-full pb-40">
                ...
                {/* <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="col-span-8 sm:col-span-4">
                    <div className="border rounded-md bg-gray-100 dark:bg-gray-700 p-2 min-h-12">
                      <div className="flex flex-wrap gap-2 mb-2">
                        {formData.variants.map((variant, index) => (
                          <div key={index} className="bg-emerald-100 dark:bg-emerald-800 text-emerald-800 dark:text-emerald-100 px-3 py-1 rounded-md flex items-center">
                            <span>{variant}</span>
                            <button
                              type="button"
